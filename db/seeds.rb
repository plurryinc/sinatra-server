...
product_feed2 = Product.create(group_id: group.id, code: 'RDE2E', product_id: 'feedbin-20151104-4116cc73b', secret_token: 'a0b0c0d0', product_type: 1)
product_move2 = Product.create(group_id: group.id, code: 'RED2D', product_id: 'move-20151104-2605d4d41', secret_token: 'a1b1c1d1', product_type: 1)
